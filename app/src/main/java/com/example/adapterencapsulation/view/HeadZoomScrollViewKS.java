...
public class HeadZoomScrollViewKS extends ScrollView {
    ...
    private float mScrollRate = 0.5f;//缩放系数，缩放系数越大，变化的越大
    private float mReplyRate = 0.5f;//回调系数，越大，回调越慢

    public HeadZoomScrollViewKS(Context context) {
        super(context);
    }

    public HeadZoomScrollViewKS(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public HeadZoomScrollViewKS(Context context, AttributeSet attrs, int defStyleAttr) {
